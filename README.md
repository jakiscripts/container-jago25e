...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jago25e.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jago25e.containers.anotherwebservice.com/
...
```
git clone git@github.com:jakiscripts/container-jago25e.git
cd container-jago25e
```
...
```
docker attach container-jago25e
```
